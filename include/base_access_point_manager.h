...
public:
    ...
    // Spin the HTTP/DNS server loop until the user posts "/save" and the
    // device reboots. Display updates (banners, animation changes) are the
    // caller's responsibility — override in a concrete subclass if needed.
